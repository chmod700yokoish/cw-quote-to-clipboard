...
function getMessageTime(message) {
	return message.children[0].children[
		message.children[0].children.length - 1
...
function getMessageAid(message) {
	...
	if (message.children[0].children.length < 3) {
		...
		return messageWithAid.children[0].children[0].children[0].children[0].getAttribute(
			"data-aid",
		);
	}
	return message.children[0].children[0].children[0].children[0].getAttribute(
		"data-aid",
	);
}
